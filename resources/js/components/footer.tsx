                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul className="mt-4 space-y-4">
                                    ...
                                    <li>
                                        <Link href="/products?sort=created_at&order=desc" className="text-base text-gray-300 hover:text-white">
                                            New Arrivals
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href="/products?sort=price&order=asc" className="text-base text-gray-300 hover:text-white">
                                            Sale
                                        </Link>
                                    </li>
                                </ul>
