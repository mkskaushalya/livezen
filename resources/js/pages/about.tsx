    ...
    const features = [
        {
            ...
            description:
                'All our sellers are verified and trusted partners who meet our quality standards.',
        ...
        },
        {
            ...
            description:
                'Every product goes through our quality assurance process.',
            icon: StarIcon,
        },
    ];
                ...
                <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-indigo-100">
                            We're building the future of e-commerce by
                            connecting trusted sellers with customers worldwide.
                            Our mission is to create a marketplace where
                            quality, trust, and innovation come together.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="mt-4 text-lg leading-8 text-gray-600">
                            ...
                            LiveZen for their shopping needs.
                        </p>
                    </div>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            We've built our platform with you in mind, focusing
                            on quality, trust, and convenience.
                        </p>
                    </div>
            ...
            <div className="bg-white py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            LiveZen was born from a simple idea: create a
                            marketplace where trust and quality come first. We
                            started as a small team of passionate individuals
                            who believed that e-commerce could be better, more
                            transparent, and more focused on building genuine
                            relationships between buyers and sellers.
                        </p>
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            Today, we're proud to be home to thousands of
                            trusted sellers and millions of satisfied customers.
                            Our platform continues to evolve, driven by feedback
                            from our community and our commitment to providing
                    ...
                    <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        <div className="flex flex-col lg:pb-6">
                            ...
                            <p className="mt-6 text-base leading-7 text-gray-600">
                                To create the world's most trusted e-commerce
                                platform where every transaction is built on
                                transparency, quality, and mutual respect
                        ...
                        <div className="flex flex-col lg:pb-6">
                            ...
                            <p className="mt-6 text-base leading-7 text-gray-600">
                                A world where online shopping is not just
                                convenient, but also builds communities,
                                supports local businesses, and contributes to a
                ...
                <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-indigo-200">
                            ...
                            amazing products from trusted sellers.
                        </p>
